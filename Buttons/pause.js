        ...
        async execute(interaction, client){
            ...
            try {
                ...
                while (queue.paused === false) {
                    ...
                    embed.setColor("Orange").setDescription(":pause_button: The song has been paused.");
                    await interaction.reply({ embeds: [embed], ephemeral: true });
                    setTimeout(()=> {
                        interaction.deleteReply();
                    }, 1500) 
                } while (queue.paused === true) { 
                    embed.setColor("Red").setTitle("Uh, oh!").setDescription("The queue has already been paused!"); 
